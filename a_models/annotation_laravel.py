...
def dynamic_wildcard(entity, update, printx, space):  
    ...
    for x in result:    
        ...
        # ------------------------------------------------------   
        wildcard(entity, new_nama, nama, label, idx, update, printx, space)
        # ------------------------------------------------------   
        time.sleep(0.05)
...
def wildcard(entity, ner, namaX, labelX, anotasi_idx, update, printx, space):  
    # ----------------------------------------------------------   
    space += "__"
    # ---------------------------------------------------------- 
    ...
    for x in result:    
        ...
        counter_token = 0
        # ------------------------------------------------------
        # panjang_dataset     = len(token_dataset)
        # counter_panjang     = ""
        # word_old_label      = ""
        # # ------------------------------------------------------
        # for i in range(panjang_dataset):
        #     counter_panjang     += str(i) + " "
        #     word_old_label      += old_label[i] + " " 
        # ------------------------------------------------------
